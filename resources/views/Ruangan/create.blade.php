        ...
        <div class="card-box mb-30">
            ...
            <div class="pb-20" style="margin-top: 30px;">
                <div class="container">
                    ...
                    <!-- Form -->
                    <form action="{{ url('/ruangan') }}" method="POST" autocomplete="off" id="formRuangan">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="Kode_Ruangan" id="Kode_Ruangan" placeholder="Kode Ruangan">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <!-- Nama Ruangan -->
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="Nama_Ruangan" id="Nama_Ruangan" placeholder="Nama Ruangan">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="Jenis_Ruangan" style="width: 100%" id="Jenis_Ruangan" required class="form-control custom-select2">
                                        ...
                                        <option value="2">Ruang Praktek</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Jurusan -->
