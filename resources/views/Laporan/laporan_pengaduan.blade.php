        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="pull-right">
                    <form action="{{ url('/laporan/download/pengaduan') }}" method="POST" id="form-laporan">
                        {{ csrf_field() }}
    ...
    <div class="row">
        <div class="col-xl-12 mb-30">
            <div class="card-box height-100-p pd-20">
                <h4 class="h4 text-blue">Statistik Pengaduan Perbulan</h4>
                <div id="chart5"></div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        ...
        data_ringan = [
            @foreach($data['pengaduan_ringan'] as $ringan)
                parseInt("{{ $ringan }}"),
            @endforeach
        ];

        data_berat = [
            @foreach($data['pengaduan_berat'] as $berat)
                parseInt("{{ $berat }}"),
            @endforeach
        ];
        ...
        var options5 = {
            series: [{
                name: 'Pengaduan Rusak Ringan',
                type: 'area',
                data: data_ringan,
            }, {
                name: 'Pengaduan Rusak Berat',
                type: 'area',
                data: data_berat,
            }],
            chart: {
