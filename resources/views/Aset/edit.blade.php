            ...
            <form action="{{ url('/aset/' . $data['aset']->Kode_Aset . '/edit') }}" method="POST" id="formAset" autocomplete="off" enctype="multipart/form-data">
                <div class="pb-20" style="margin-top: 30px;">
                    <div class="container">
                        ...
                        <!-- Input Hidden -->
                        <input type="hidden" id="Total" name="Total" value="{{ $data['aset']->Total_Aset }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <select name="Jenis_Aset" id="Jenis_Aset" class="form-control custom-select2" style="width: 100%">
                                        <option selected disabled>-- Pilih --</option>
                                        <option value="1" @if($data['aset']->Jenis_Aset === 1) selected="selected" @endif >Berwujud</option>
                                        <option value="2" @if($data['aset']->Jenis_Aset === 2) selected="selected" @endif >Habis Pakai</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <select type="text" class="form-control custom-select2"  id="Kondisi_Aset" name="Kondisi_Aset" placeholder="Kondisi Aset" style="width: 100%">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date-picker" id="Tanggal_Masuk" name="Tanggal_Masuk_Input" placeholder="Tanggal Masuk dd/mm/YYYY" value="{{ date('d F Y', strtotime($data['aset']->Tanggal_Masuk)) }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
