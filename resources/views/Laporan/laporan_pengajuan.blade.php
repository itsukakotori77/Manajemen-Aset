        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="pull-right">
                    <form action="{{ url('/laporan/download/pengajuan') }}" method="POST" id="form-laporan">
                        {{ csrf_field() }}
    ...
    <div class="row">
        <div class="col-xl-12 mb-30">
            <div class="card-box height-100-p pd-20">
                <h4 class="h4 text-blue">Statistik Pengajuan Perbulan</h4>
                <div id="chart5"></div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        ...
        data_disetujui = [
            @foreach($data['pengajuan_disetujui'] as $disetujui)
                parseInt("{{ $disetujui }}"),
            @endforeach
        ];
